...
class ControllerExtensionPaymentDNAPayments extends Controller {
    ...
    'fields' => array(
      array('name' => 'dna_payments_client_id', 'value' => ''),
      array('name' => 'dna_payments_client_secret', 'value' => ''),
      array('name' => 'dna_payments_terminal', 'value' => ''),
      array('name' => 'dna_payments_test_client_id', 'value' => ''),
      array('name' => 'dna_payments_test_client_secret', 'value' => ''),
      array('name' => 'dna_payments_test_terminal', 'value' => ''),
      array('name' => 'dna_payments_test_mode', 'value' => '1'),
      array('name' => 'dna_payments_description', 'value' => ''),
      array('name' => 'dna_payments_sort_order', 'value' => '0'),
      array('name' => 'dna_payments_status', 'value' => '0'),
      array('name' => 'dna_payments_type', 'value' => '1'),
      array('name' => 'dna_payments_order_status_paid_id', 'value' => '15'),
      array('name' => 'dna_payments_order_status_progress_id', 'value' => '1'),
      array('name' => 'dna_payments_payment_method_name', 'value' => 'Visa / Mastercard /American Express / Diners Club / Other'),
    ),
    'errors' => array(
      'error_client_id',
      'error_client_secret',
    ...
    'validate' => array(
      'always' => array('dna_payments_payment_method_name'),
      'test' => array('dna_payments_test_client_id', 'dna_payments_test_client_secret', 'dna_payments_test_terminal'),
      'prod' => array('dna_payments_client_id', 'dna_payments_client_secret', 'dna_payments_terminal'),
    ),
	);
    ...
    if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
      $this->model_setting_setting->editSetting('dna_payments', $this->request->post);

      $this->session->data['success'] = $this->language->get('text_success');

      $this->response->redirect($this->prepareExtensionUrlLink('extension/extension'));
    }
    ...
    $data['cancel'] = $this->prepareExtensionUrlLink('extension/extension');
    ...
    if (!$this->request->post['dna_payments_test_mode']) {
    ...
    $error_name = str_replace('dna_payments', 'error', $field_name);
    ...
    return array(
      ...
      array(
        ...
        'href' => $this->prepareExtensionUrlLink('extension/extension')
      ),
      array(
	...
	{
    return $this->url->link($link, 'token=' . $this->session->data['token'] . $params, true);
	}
